...
describe('Accessibility Features', () => {
  ...
  it('should support full keyboard navigation', () => {
    ...
    // Test Tab navigation
    fireEvent.keyDown(stepper, { key: 'Tab' });
    expect(document.activeElement).toHaveAttribute('aria-label', /assignment prompt/i);
  });
  ...
  it('should have proper heading hierarchy', () => {
    ...
    expect(mainHeading).toHaveRole('heading', { level: 1 });
    
    // Section heading
    const sectionHeading = screen.getByTestId('section-title');
    expect(sectionHeading).toHaveRole('heading', { level: 2 });
  });
