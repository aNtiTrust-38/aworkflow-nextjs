...
describe('Responsive Design', () => {
  ...
  it('should support touch-friendly interactions on mobile', () => {
    ...
    expect(nextButton).toHaveClass('touch:py-3', 'touch:px-6');
  });

  it('should adapt text sizes for different screen sizes', () => {
    const testCases = [
      { width: 320, expectedClass: 'text-sm' }, // Small mobile
      { width: 768, expectedClass: 'text-base' }, // Tablet
      { width: 1024, expectedClass: 'text-lg' }, // Desktop
      { width: 1440, expectedClass: 'text-xl' }, // Large desktop
    ];
    ...
    testCases.forEach(({ width, expectedClass }) => {
      ...
      const { rerender } = render(<WorkflowUI />);
  ...
  it('should adapt spacing and margins responsively', () => {
    ...
    sections.forEach(section => {
      // Should have responsive margins
      expect(section).toHaveClass('mb-4', 'md:mb-6', 'lg:mb-8');
      
      // Should have responsive padding
      expect(section).toHaveClass('p-2', 'md:p-4', 'lg:p-6');
    });
  });
