          ...
          { type: 'separator' },
          {
            ...
            submenu: [
              { 
                ...
                role: 'startspeaking' as any
              },
              { 
                label: 'Stop Speaking',
                role: 'stopspeaking' as any
              }
            ]
          }
        ] : [
      ...
      submenu: [
        {
          ...
          click: async () => {
            await shell.openExternal('https://github.com/your-repo/academic-workflow#readme');
          }
        },
        {
        ...
        { type: 'separator' },
        {
          ...
          click: async () => {
            await shell.openExternal('https://github.com/your-repo/academic-workflow/issues');
          }
        },
        {
